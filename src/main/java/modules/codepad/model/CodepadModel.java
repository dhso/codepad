...
public class CodepadModel extends Model<CodepadModel> {
	...
	public Page<Record> getArticlePageList(Integer pageNumber, Integer pageSize) {
		return Db.paginate(pageNumber, pageSize, "select id,text,open,article,create_id,create_dt,update_id,update_dt", "from codepad_article where node = '0' order by update_dt desc");
	}
}
